...
from Analysis.Actions.SendMessageToTradeModule import SendBuyMessage, SendSellMessage;
...
class SendMessagesToTradeModuleTest(unittest.TestCase):
    ...
    def test_overall(self):
        ...
        buyer = SendBuyMessage(coin_symbol=asset_symbol);
        seller = SendSellMessage(coin_symbol=asset_symbol);
